...
def gen_info():
	...
	ret = "More information can be found " + A("at this spreadsheet", href="https://docs.google.com/document/d/1basknMfrfcH6AzJD9PkzeUunqrIGTuS6SfXPf3a7pso/preview", target="_blank") +" or " + A("these patch notes", href="https://www.blackdesertonline.com/news/view/3216", target="_blank") + BR() + BR()
	ret += "Barter items that you can trade for ship parts unlock as you finish more trades.  You can always trade t1 barter items for verdant stone coupon though." + BR()
