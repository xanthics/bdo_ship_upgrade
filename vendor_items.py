...
items = {
	...
	"Cox Pirates' Artifact (Combat)": ["800 Sea Coins", "3x per [Daily] Do You Have What it Takes?", "Cox Ghost Pirate ship drop", "Cox Pirate Extermination Seal X200"],
	"Deep Sea Memory Filled Glue": ["140 Sea Coins", "8x per [Daily] Ravikel's Test"],
	...
	"Tide-Dyed Standardized Timber Square": ["350 Sea Coins", "3x per daily", "Cox Ghost Pirate ship drop"],
	"Deep Tide-Dyed Standardized Timber Square": ["1,000 Sea Coins", "3x per [Daily] Win-win Situation", "Cox Ghost Pirate ship rare drop"],
	"Moon Vein Flax Fabric": ["600 Sea Coins", "3x per daily", "10x from drying Khan's Tendon"],
	"Moon Scale Plywood": ["160 Sea Coins", "10x per daily", "10x from drying Khan's Scale"],
