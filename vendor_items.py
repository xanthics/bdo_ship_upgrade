...
items = {
	...
	"Epheria: Old Figurehead": ["Buy from Falasi. 3.5 mil."],
	"Epheria: Old Plating": ["Buy from Falasi. 4 mil."],
	"Epheria: Old Cannon": ["Buy from Falasi. 3.5 mil."],
	"Epheria: Old Wind Sail": ["Buy from Falasi. 3 mil."],
...
#	"Khan's Concentrated Magic": [],
	...
	"Seaweed Stalk": ["6x per [Daily] Precious Coral Piece", "Suspicious Cargo Ship"],
...
#	"Cox Pirates' Artifact (Parley Beginner)": [],
	...
	"Cox Pirates' Artifact (Combat)": ["6x per [Weekly] OMG's Black Rust Hunter", "3x per [Daily] Do You Have What it Takes?", "Cox Pirates' Shadow Ghost drop", "Cox Pirate Extermination Seal X200", "2x per [Weekly] Monster Increase Report" ],
	"Deep Sea Memory Filled Glue": ["8x per [Daily] Ravikel's Test", "Young Ocean Stalker"],
	"Brilliant Pearl Shard": ["Candidum", "Nineshark"],
	"Ruddy Manganese Nodule": ["4x per [Weekly] OMG's Candidum Hunter", "2x per [Daily] For the Young Otter Merchants", "Suspicious Cargo Ship"],
	"Tear of the Ocean": ["2x per [Weekly] OMG's Nineshark Hunter", "1x per [Daily] OMG's Black Rust Hunter", "1x per [Daily] OMG's Young Sea Monster Hunter"],
#	"Khan's Tendon": [],
#	"Khan's Scale": [],
	"Tide-Dyed Standardized Timber Square": ["5x per [Daily] Our Guild is not a Charity Group", "Cox Pirates' Shadow Ghost drop"],
	"Deep Tide-Dyed Standardized Timber Square": ["4x per [Daily] Win-win Situation", "Cox Pirates' Shadow Ghost"],
	"Moon Vein Flax Fabric": ["3x per [Daily] OMG's Nineshark Hunter", "3x per [Daily] OMG's Young Sea Monster Hunter", "10x from drying Khan's Tendon"],
	"Moon Scale Plywood": ["10x per [Daily] OMG's Candidum Hunter", "10x per [Daily] OMG's Young Sea Monster Hunter", "10x from drying Khan's Scale"],
	"Tidal Black Stone":["1-50x from defeating Great Ocean Sea Creatures", "10x per The Ravinia's Wiggly-Waggly Letter quest."],
#	"Mandragora Essence": [],
}
