...
items = {
	...
	"Verdant Black Stone": ["100 total from Ravinia's quest rewards day 1&4", "5 per completion of the Great Sea MSQ"],
	...
	"Cox Pirates' Artifact (Combat)": ["800 Sea Coins", "3x per daily", "Cox Ghost Pirate ship drop", "Cox Pirate Extermination Seal X200"],
	...
	"Deep Tide-Dyed Standardized Timber Square": ["1,000 Sea Coins", "3x per daily", "Cox Ghost Pirate ship rare drop"],
