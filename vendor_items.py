...
items = {
	...
	"Tear of the Ocean": ["3,900 Sea Coins", "1x per [Daily] OMG's Black Rust Hunter", "0.5x per [Daily] OMG's Young Black Rust Hunter"],
	...
	"Moon Vein Flax Fabric": ["600 Sea Coins", "3x per [Daily] OMG's Nineshark Hunter", "1x per [Daily] OMG's Young Nineshark Hunter", "10x from drying Khan's Tendon"],
	"Moon Scale Plywood": ["160 Sea Coins", "10x per [Daily] OMG's Candidum Hunter", "5x per [Daily] OMG's Young Candidum Hunter", "10x from drying Khan's Scale"],
